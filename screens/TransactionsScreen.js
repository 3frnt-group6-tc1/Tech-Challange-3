      ...
      <View style={[styles.modalContainer, { backgroundColor: theme.colors.background }]}>
        <View style={[styles.modalHeader, { borderBottomColor: theme.colors.border }]}>
          <TouchableOpacity onPress={() => setShowFilters(false)}>
            <Text style={[styles.modalButton, { color: theme.colors.primary }]}>Cancelar</Text>
          </TouchableOpacity>
          <Text style={[styles.modalTitle, { color: theme.colors.text }]}>Filtros</Text>
          <TouchableOpacity onPress={clearFilters}>
            <Text style={[styles.modalButton, { color: theme.colors.primary }]}>Limpar</Text>
          </TouchableOpacity>
        </View>

        <ScrollView style={styles.modalContent}>
          <Card style={styles.filterSection}>
            <Text style={[styles.filterTitle, { color: theme.colors.text }]}>Tipo de Transação</Text>
              ...
              {[
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.filterOption,
                    {
                      backgroundColor: filters.type === option.value ? theme.colors.primary : theme.colors.surface,
                ...
                >
                  <Text style={[
                    ...
                    { color: filters.type === option.value ? 'white' : theme.colors.text }
                  ]}>
                    {option.label}
                  </Text>
                </TouchableOpacity>
          ...
          <Card style={styles.filterSection}>
            <Text style={[styles.filterTitle, { color: theme.colors.text }]}>Categoria</Text>
            <View style={styles.filterOptions}>
              {categories.map(category => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.filterOption,
                    {
                      backgroundColor: filters.category === category ? theme.colors.primary : theme.colors.surface,
                      borderColor: theme.colors.border
                    }
                  ]}
                ...
                >
                  <Text style={[
                    styles.filterOptionText,
                    { color: filters.category === category ? 'white' : theme.colors.text }
                  ]}>
          ...
          <Card style={styles.filterSection}>
            <Text style={[styles.filterTitle, { color: theme.colors.text }]}>Período</Text>
            <View style={styles.filterOptions}>
              {[
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.filterOption,
                    {
                      backgroundColor: filters.dateRange === option.value ? theme.colors.primary : theme.colors.surface,
                      borderColor: theme.colors.border
                    }
                  ]}
                ...
                >
                  <Text style={[
                    styles.filterOptionText,
                    { color: filters.dateRange === option.value ? 'white' : theme.colors.text }
                  ]}>
                    {option.label}
                  </Text>
                </TouchableOpacity>
          ...
          <Card style={styles.activeFiltersCard}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
              <View style={styles.activeFiltersList}>
                {filters.type !== 'all' && (
                  <View style={[styles.activeFilterTag, { backgroundColor: theme.colors.primary + '20' }]}>
                  ...
                  <View style={[styles.activeFilterTag, { backgroundColor: theme.colors.primary + '20' }]}>
                    <Text style={[styles.activeFilterText, { color: theme.colors.primary }]}>
                      {filters.dateRange === 'today' ? 'Hoje' :
                       ...
                       filters.dateRange === 'month' ? 'Este mês' : 'Este ano'}
                    </Text>
                  </View>
                )}
              </View>
          ...
          ListEmptyComponent={
            <Card style={styles.emptyCard}>
              <Text style={[styles.emptyText, { color: theme.colors.textSecondary }]}>
                {hasActiveFilters() ? 'Nenhuma transação encontrada com os filtros aplicados' : 'Nenhuma transação cadastrada'}
              </Text>
            </Card>
          }
        />
          ...
          <Card style={styles.paginationCard}>
            <View style={styles.paginationInfo}>
              <Text style={[styles.paginationText, { color: theme.colors.textSecondary }]}>
                Página {currentPage} de {totalPages} • {filteredTransactions.length} transação{filteredTransactions.length !== 1 ? 'ões' : ''}
              </Text>
            </View>
